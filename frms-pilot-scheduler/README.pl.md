...
> M. Kasperek, *FRMS Pilot Scheduler* (oprogramowanie w Pythonie), Apache-2.0. GitHub: https://github.com/vonKrappitz/frms-pilot-scheduler. Zenodo DOI: *(do uzupełnienia po zarchiwizowaniu pierwszego release)*.
